...
import 'location_edit_viewmodel.dart';
...
class EditLocationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<EditLocationViewModel>.reactive(

      viewModelBuilder: () => EditLocationViewModel(),

      //disposeViewModel: false,
      //initialiseSpecialViewModelsOnce: true,
      //fireOnModelReadyOnce: true,

      onModelReady: (model)async{await model.initializer(isHome: isHomeTag, isWork: isWorkTag,savedAddress: savedLocation,context: context);},
                            ...
                            Column(
                              children: [
                                            ...
                                            child: RawMaterialButton(
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  children: [
                                                    Text((model.addressName != null)? model.addressName : 'Location',
                                ...
                                Container(
                                  ...
                                  child: TextButton(
                                    style: ButtonStyle(
                                      overlayColor: MaterialStateProperty.all(Theme.of(context).colorScheme.surface.withOpacity(0.1)),
                                    ...
                                    child: Text(
                                      'DELETE',
                                      style: Theme.of(context).textTheme.button!.apply(color: Theme.of(context).colorScheme.error),
                                    ),
                                  ),
                                ),
                              ],
