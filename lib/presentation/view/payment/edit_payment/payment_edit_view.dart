...
import 'payment_edit_viewmodel.dart';
...
class EditPaymentView extends StatefulWidget {
  ...
  @override
  _EditPaymentViewState createState() => _EditPaymentViewState();
}
...
class _EditPaymentViewState extends State<EditPaymentView> {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<EditPaymentViewModel>.reactive(
      viewModelBuilder: () => EditPaymentViewModel(),

      //disposeViewModel: false,
      //initialiseSpecialViewModelsOnce: true,
      fireOnModelReadyOnce: true,

      onModelReady: (model)async{await model.initialized(widget.paymentMethods, context);},
