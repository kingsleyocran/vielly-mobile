...
import 'all_ticket_viewmodel.dart';
...
class _TicketViewState extends State<AllTicketView> {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<AllTicketViewModel>.reactive(
      viewModelBuilder: () => AllTicketViewModel(),
                              ...
                              child: Column(
                                children: [
                                  ListView.separated(
                                    ...
                                    itemCount: (model.loadingState == LoadingState.loading) ? 2 : model.ticketDetailsList.length,
                                    shrinkWrap: true,
                                    ...
                                    itemBuilder: (context, index) {
                                      return
                                        ...
                                        TicketEmptyCard()
                                            :
                                        TicketCard(
                                            ticketDetails: model.ticketDetailsList[index],

                                            function: () {
                                              model.navigateToTicket(model.ticketDetailsList[index]);
                                            }
                                        );
                                ...
                                Container(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        child: Text(
                                          '${AppLocalizations.of(context)!.bookedTickets}',
