...
class _RideHistoryCardState extends State<RideHistoryCard> {
  ...
  void dateFormat(){
    ...
    var date = DateFormat('yMd').parse(widget.rideHistory.createdAt);
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        child: Text(
                          "${DateFormat('EEE - d MMM, yyyy').format(DateTime.fromMicrosecondsSinceEpoch(int.parse((widget.rideHistory.createdAt).toString())))}",
                          style:
...
class RideHistoryEmptyCard extends StatelessWidget {
  final ThemeService _themeService = locator<ThemeService>();
