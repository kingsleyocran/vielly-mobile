...
class _ButtonWhiteState extends State<ButtonWhite> with TickerProviderStateMixin {
  AnimationController? _animationController;
  Animation<double>? _pressedAnimation;

  TickerFuture? _downTicker;

  double get buttonDepth => widget.size * 0.075;
  ...
  @override
  void didUpdateWidget(ButtonWhite oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final radius = BorderRadius.circular(horzPadding * 0.6);

    return Container(
      padding: widget.onPressed != null ?  EdgeInsets.only(bottom: 0, left: 0, right: 0) : null,
